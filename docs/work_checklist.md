...
- **마지막 갱신**: 2026-08-15 · 기준 commit `PENDING` · `uv run pytest -q` 463 passed·6 skipped
...
**1차 출시선(A+B+C+D+F) 기준으로 A 1건 · D 3건 · F 5건이 남았다.** E는 출시 후 — 다만 **E-21 1단계는 1차 출시에 붙일 수 있고, E-17은 외부 관문이 없어 지금도 착수 가능하다.**
...
- [x] **A-6** 랭킹 부가 지표 살리기 — 2026-08-15 `PENDING`
