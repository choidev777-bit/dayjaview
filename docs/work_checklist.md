...
- **마지막 갱신**: 2026-08-16 · 기준 commit `a30ba7e` (E-17 완료) · `uv run pytest -q` 569 passed·8 skipped
...
- [x] **E-17** 사건·소재 온톨로지 — 2026-08-16 `a30ba7e`
  ...
  - 설계 절차는 작업 정의 그대로: 전수 39,696건 어절 빈도 분석 → 고정 seed(20260816) 표본 1,000건 정독 → 유형 확정. **게이트: 기타(미분류) 전수 5.9%·표본 3.1%** (기준 10% 이하 → GO). 표본 100건 재정독 대조로 primary 명백 오류 ~2건 수준 확인.
