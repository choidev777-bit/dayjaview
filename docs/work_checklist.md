...
- **마지막 갱신**: 2026-08-15 · 기준 commit `f63bdb7` · `uv run pytest -q` 472 passed·6 skipped
...
| C. 화면 | 2 / 2 | — |
| D. 매일 자동 운영 | 1 / 3 | D-14, D-15 |
| E. 과거 연구 | 0 / 6 | E-16 ~ E-21 |
| F. 출시 | 0 / 5 | F-21 ~ F-25 |

**1차 출시선(A+B+C+D+F) 기준으로 A 1건 · D 2건 · F 5건이 남았다.** E는 출시 후 — 다만 **E-21 1단계는 1차 출시에 붙일 수 있고, E-17은 외부 관문이 없어 지금도 착수 가능하다.**
